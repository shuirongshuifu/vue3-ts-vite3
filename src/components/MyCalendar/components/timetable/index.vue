        ...
        >
          ...
          <div className="vc-calendar-content">
            <div v-for="(days,k1) in monthRender.value" :key="k1" class="vc-calendar-row" >
              ...
              >
                <div :class="['vc-calendar-day-container', child.tileContent?.className]">
                  ...
                  <div :class="['vc-calendar-slot-element']" v-if="child.tileContent">{{child.tileContent.content}}</div>
...
.cur {
    background-image: url('../svg/cur.svg');
    background-position: center 14px;
    background-repeat: no-repeat;
}
.next {
