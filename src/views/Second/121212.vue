<template>
    <div class="container">
        <div class="container-select-modes">
            ...
            />
            <!--multi mode-->
            <Calendar selectMode="multi" class-name="multi-mode" language="en" :tile-content="multiTileContent"
                :select-date="multiModeDate" :begin="begin" :end="end" @onSelect="onSelect" />
            <!--range mode-->
            <Calendar monFirst backgroundText selectMode="range" :lunar="lunar" class-name="range-mode"
                :format="formatOfRangeMode" :select-date="rangeModeDate" language="cn" @onSelect="onSelect" />
            <!--multiRange mode-->
            <Calendar monFirst completion backgroundText selectMode="multiRange" class-name="multiRange-mode"
                :select-date="multiRangeModeDate" :format="formatOfmultiMode" :weeks="weeks" @onSelect="onSelect" />
        </div>
        <div class="container-view-modes">
            <!--week mode-->
            <Calendar backgroundText :lunar="lunar" selectMode="range" class-name="week-mode" mode="week"
                ref="weekModeRef" />
            <button @click="backToToday" class="back-to-today">Back to Today</button>
            <!--monthRange mode-->
            <Calendar backgroundText selectMode="range" class-name="monthRange-mode" mode="monthRange"
...
export default {
    ...
    setup() {
        ...
        console.log('selectModeDateselectModeDate', selectModeDate);
